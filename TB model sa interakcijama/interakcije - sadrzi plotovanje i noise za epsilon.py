...
def plot_ntot_on_eps_t_graph(parameters=None, plt_density=21):
    ...
    for eps_it, eps in enumerate(eps_arr):
        for t_it, t in enumerate(t_arr):
            ...
            exp_sum = sum([calculate_expectation_value(num_op[i, :, :],
...
def plot_exp_neighbors(parameters=None, V_max=101):
    ...
    for it, V in enumerate(V_arr):
        ...
        exp_arr[it] = calculate_expectation_value(n0 @ n1, ll_eigvec)
...
def main(parameters):
    ...
    for i in range(L*L):
        ...
        n2 = get_number_operator((i+1) % (L ** 2))
    ...
    plot_ntot_on_eps_t_graph(parameters, 21)
...
if __name__ == '__main__':
    ...
    # plot_exp_neighbors()
    plot_ntot_on_eps_t_graph(plt_density=21)
